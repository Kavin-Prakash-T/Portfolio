  ...
  return (
    <section id="about" className="py-16 px-6 bg-gray-50">
       <div className="max-w-6xl mx-auto">
        <div className={`transition-all duration-1000 delay-200 ${hasAnimated?'opacity-100 translate-y-0':'opacity-0 translate-y-10'}`}>
            <h2 className="text-4xl font-bold mb-12 text-center">About Me</h2>
            <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                <p className="text-lg text-gray-700 mb-6">
                    I'm a passionate Frontend developer and Aspiring Backend developer with  1+ years of experience creating exceptional digital exceptional.I specialize in React, Java, modern CSS, MongoDB, MySQL and Spring Boot to build scalable ,performance applications. 
                </p>
                <p className="text-lg text-gray-700 mb-6">
                    My journey started with a curiosity for how websites work, and  it has evolved into a love for crafting pixel-perfect interfaces and scalable APIs that users interacting with. 
                </p>
